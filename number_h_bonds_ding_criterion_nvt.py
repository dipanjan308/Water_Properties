...
def calculate_number_of_hydrogen_bonds(pos_O_1, pos_H_1, box_dim, ho_cutoff, oo_cutoff, angle_cutoff):
    all_frame=[]
    dist_all = []
    dist_all_2 = []
...
for i in range(number_of_blocks):
    ...
    avg_hbonds = calculate_number_of_hydrogen_bonds(block_pos_O, block_pos_H, box_dim, 2.5, 3.4, 30)
